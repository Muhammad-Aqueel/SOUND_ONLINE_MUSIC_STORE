                ...
                <div class="ms_top_right">
                    ...
                    <div class="ms_top_btn">
                        ...
                        if(!(isset($_SESSION['user_email'])))
                        {
                            ...
                            echo '<a href="./login.php" class="ms_btn login_btn"><span>login</span></a>';
                        }else{
            ...
            <div class="ms_profile_wrapper" style="padding-left: 0px;">
                ...
                <div class="ms_profile_box">
                    <div class="ms_pro_img">
                        ...
                        echo '<div id="pic_cache"><img id = "profile_pic" src="images/users/'.$row['photo'].'" alt="" class="img-fluid"></div>
                    </div>
                    <div class="ms_pro_form">
                        ...
                        <h1 id="sr" style="opacity: 0; color: rgb(231, 20, 219); font-size: large; transition: opacity 0s ease 0s;margin-bottom: 0px;">_</h1>
    ...
    <script>
        ...
        function reg_user() {
            ...
            if(ok == 0) {
                ...
                xhr.open("POST", 'pass_user.php', true);
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        const data = JSON.parse(this.responseText);
                        if(data.success === 1) {
                            document.getElementById("pic_cache").innerHTML = data.photo;
