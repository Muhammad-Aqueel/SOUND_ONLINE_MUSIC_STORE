...
<body>
            ...
            <div class="ms_header">
                <div class="ms_top_left">
                    <div class="ms_top_search">
                        <input id="srch" type="text" class="form-control" placeholder="Search Artist" onkeyup="search_()">
                            ...
                            <div class="col-lg-12">
                                ...
                                echo '<div class="col-lg-2 col-md-6">
                                    <div class="ms_rcnt_box marger_bottom30">
                                        <div class="ms_rcnt_box_img">
                                        <a href="artist_single.php?artist_id='.$row['Artist_ID'].'">
                                            <img src="images/artist/artist.jpg" alt="" class="img-fluid">
                                            <div class="ms_main_overlay">
                                                <div class="ms_box_overlay"></div>
                                                <div class="ms_play_icon">
                                                    <img src="images/svg/play.svg" alt="">
    ...
    <script>
        ...
        function search_() {
            ...
            formData.append('Artist_Keyword', srch_val);
