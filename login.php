...
<body>
        ...
        <div class="padder_top80" style="padding-top: 0px !important;">
            ...
            <div class="ms_profile_wrapper">
                <div class="ms_profile_box">
                    <h1>Login / Sign In</h1>
                    <h2 id="lsr" style="opacity:0;color: rgb(231, 20, 219); font-size: large;">Login Fail</h2>
                    <div class="ms_pro_form">
                        <form id="login_form" method="post">
                            ...
                            <a href="javascript:{}" class="ms_btna" id="login_btn" onclick="login_user()" name="login">login now</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        rinput = document.querySelectorAll('input');
