    ...
    <div class="ms_main_wrapper">
        ...
        <div class="ms_album_single_wrapper">
            <div class="album_single_data">
                ...
                <?php
                    $sql = "SELECT * FROM `album` WHERE Album_ID = " . $_GET['album_id'];
                    $result = mysqli_query($link,$sql);
                    $row = mysqli_fetch_assoc($result);
                    if(!(mysqli_num_rows($result) > 0)){exit();}
                    echo '<img src="images/album/album.jpg" alt="" class="img-fluid">
                        </div>
			...
			<div class="album_inner_list">
				<div class="album_list_wrapper">
					<ul class="album_list_name">
                        ...
                        <?php
						$sql = "SELECT videos_songs.VS_ID,videos_songs.Title,album.Album_ID,album.Name FROM album INNER JOIN videos_songs ON album.Album_ID = videos_songs.Album_ID WHERE album.Album_ID = " . $_GET['album_id'];
                        $result = mysqli_query($link,$sql);
                        $cout = 1;
